Scaling [myawesometmlsolutionml-7fe7-43df] With Kubernetes
===========================
...
Based on your TML solution [myawesometmlsolutionml-7fe7-43df] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`myawesometmlsolutionml-7fe7-43df.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-myawesometmlsolutionml-7fe7-43df.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingressmyawesometmlsolutionml-7fe7-43df.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f myawesometmlsolutionml-7fe7-43df.yml

myawesometmlsolutionml-7fe7-43df.yml
------------------------

.. important::
   Copy and Paste this YAML file: myawesometmlsolutionml-7fe7-43df.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# myawesometmlsolutionml-7fe7-43df.yml
     ...
     kind: Deployment
     metadata:
       name: myawesometmlsolutionml-7fe7-43df
     spec:
       selector:
         matchLabels:
           app: myawesometmlsolutionml-7fe7-43df
       ...
       template:
         ...
         spec:
           containers:
           - name: myawesometmlsolutionml-7fe7-43df
             image: rmousavi/myawesometmlsolutionml-7fe7-43df-amd64:latest
             volumeMounts:
             - name: dockerpath
             ...
             - name: TSS
               value: '0'
             - name: PROJECTNAME
               value: 'myawesometmlsolutionml-7fe7'                              
             - name: SOLUTIONNAME
               value: 'myawesometmlsolutionml-7fe7-43df'
             - name: SOLUTIONDAG
               value: 'solution_preprocessing_dag-myawesometmlsolutionml-7fe7'
             - name: GITUSERNAME
               value: 'rmousavi-raspberry'
             - name: GITREPOURL
               value: 'https://github.com/rmousavi-raspberry/raspberrypitss.git'
   ...
   ---
     ...
     kind: Service
     metadata:
       name: myawesometmlsolutionml-7fe7-43df-visualization-service
       labels:
         app: myawesometmlsolutionml-7fe7-43df-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/myawesometmlsolutionml-7fe7-43df 6060:6060
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-myawesometmlsolutionml-7fe7-43df.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-myawesometmlsolutionml-7fe7-43df.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-myawesometmlsolutionml-7fe7-43df.yml
