[myawesometmlsolutionml-7fe7-43df] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [myawesometmlsolutionml-7fe7-43df] container is NOT running**.

.. tip::
   You must have your [myawesometmlsolutionml-7fe7-43df] container running before connecting to the Visualization and Airflow URLs.
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  -v /your_localmachine/foldername:/rawdata:z  \-\-env GITREPOURL=https://github.com/rmousavi-raspberry/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=42785  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='rmousavi-raspberry'  \-\-env DOCKERUSERNAME='rmousavi'  \-\-env MQTTUSERNAME=' '  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  \-\-env UPDATE=1  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:9005/iot-failure-machinelearning.html?topic=iot-preprocess,iot-ml-prediction-results-output&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
[myawesometmlsolutionml-7fe7-43df] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/rmousavi-raspberry/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/myawesometmlsolutionml-7fe7-43df
...
.. important::
   solution_preprocessing_dag-myawesometmlsolutionml-7fe7
...
.. important::
   VIPERHOST_PRODUCE=172.17.0.2, VIPERPORT_PRODUCE=5050, VIPERHOST_PREPOCESS=172.17.0.2, VIPERPORT_PREPROCESS=36839, VIPERHOST_PREPOCESS2=172.17.0.2, VIPERPORT_PREPROCESS2=33195, VIPERHOST_PREPOCESS_PGPT=172.17.0.2, VIPERPORT_PREPROCESS_PGPT=39351, VIPERHOST_ML=172.17.0.2, VIPERPORT_ML=36961, VIPERHOST_PREDCT=172.17.0.2, VIPERPORT_PREDICT=34761, HPDEHOST=172.17.0.2, HPDEPORT=39349, HPDEHOST_PREDICT=172.17.0.2, HPDEPORT_PREDICT=43731

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-638-myawesometmlsolutionml-7fe7-43df,solution_preprocessing_dag-myawesometmlsolutionml-7fe7, python-preprocess-112-myawesometmlsolutionml-7fe7-43df,solution_preprocessing_dag-myawesometmlsolutionml-7fe7, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
